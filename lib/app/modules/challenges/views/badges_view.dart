            ...
            Stack(
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    color: Get.find<ChallengesController>()
                        ...
                        : context.greyLightBg,
                    border: Border.all(
                        color: Get.find<ChallengesController>().badgesList[index].progress == Get.find<ChallengesController>().badgesList[index].conditionValue ? context.brandBorderColor : context.greyBorder),
                                  ...
                                  children: [
                                    Expanded(
                                      child: LinearProgressIndicator(
                                        ...
                                        value: (Get.find<ChallengesController>()
                                                .badgesList[index]
                                                .progress! /
                                            Get.find<ChallengesController>()
                                                .badgesList[index]
                ...
                Get.find<ChallengesController>()
                    ...
                    Get.find<ChallengesController>()
                        .badgesList[index]
                        .conditionValue ?Container() :   Container(
                  decoration: BoxDecoration(
