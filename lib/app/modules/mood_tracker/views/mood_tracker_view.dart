              ...
              headerSliverBuilder: (_, __) => [
                    Obx(
                      () => SliverAppBar(
                        ...
                        expandedHeight:
                            controller.currentCatenderIndex.value == 1
                                ? 460.ksp
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        CalenderTabBar(
                                          backgroundColor:
                                              context.lightBrand3Color,
                                          selectedTabColor:
                                              context.lightBrand2Color,
                                          tabController:
                                              controller.tabController,
                                          title1: "",
                                          title2: "",
                                          labelColor: ColorUtil(context)
                                              .lightBrand3Color,
                                    ...
                                    if (controller.currentCatenderIndex.value ==
                                        1)
              ...
              body: Container(
                  ...
                  child: Obx(() {
                    ...
                    if (controller.entries.isEmpty) {
                      return Center(
                          child: Text(
                              'No moods logged on ${controller.selectedDate.value}'));
                    }
