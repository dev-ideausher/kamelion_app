          ...
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    CommonImageView(svgPath: ImageConstant.cleoWriting),
                    28.kwidthBox,
                    Column(
                      children: [
                        Stack(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                controller.onboardingQuestionsList[controller
                                    .currentQuetionIndex
                                    .value],
                ...
                ...(controller.currentQuetionIndex.value !=
                        (controller.onboardingQuestionsList.length - 1))
                    ? controller.onboardingAnswerList[controller.currentQuetionIndex.value].map((
                      item,
                    ) {
                      return Padding(
                        ...
                        child: InkWell(
                          onTap:
                              () => controller.selectAnswer(
                                answerIndex: controller
                                    .onboardingAnswerList[controller
                                        .currentQuetionIndex
                                        .value]
                                    .indexOf(item),
                                questionIndex:
                          ...
                          child: Container(
                            width: context.width,
                            padding: EdgeInsets.symmetric(vertical: 9.5.ksp),
                            decoration: BoxDecoration(
                              color: ColorUtil(context).white,
                              ...
                              border: Border.all(
                                color:
                                    (controller.selectedQuestionsIndexes[controller
                                                    .currentQuetionIndex
                                                    .value] !=
                                                null &&
                                            controller
                                                    ...
                                                    .currentQuetionIndex
                                                    .value][controller
                                                    .selectedQuestionsIndexes[controller
                                                    .currentQuetionIndex
                                                    .value]!] ==
                                                item)
                      ...
                      Center(
                        child: SliderTheme(
                          data: SliderTheme.of(context).copyWith(
                            ...
                            valueIndicatorColor: ColorUtil(context).white,
                            valueIndicatorTextStyle: TextStyle(
                              color: ColorUtil(context).black,
                              fontWeight: FontWeight.bold,
                            ),
                            thumbColor: ColorUtil(context).white,
                            activeTrackColor: ColorUtil(context).brandColor1,
                          ),
                          child: Slider(
                            value:
                                ((controller.selectedQuestionsIndexes[controller
